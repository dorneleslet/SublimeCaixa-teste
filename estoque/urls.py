...
urlpatterns = [
    path('', views.listar_estoque, name='listar_estoque'), #pagina inicial do estoque
    ...
    path('produtos/lista/', views.lista_produtos, name='lista_produtos'), #listagem dos produtos em editar produtos
